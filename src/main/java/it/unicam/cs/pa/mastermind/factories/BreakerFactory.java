...
/**
 * <b>Responsabilità</b>: fornire istanze di implementazioni di
 * <code>CodeBreaker</code>. Interfaccia finalizzata all'implementazione di
 * classi factory per le particolari implementazioni dei giocatori
...
public interface BreakerFactory extends PlayerFactory {
	 ...
	 * @param seqLength lunghezza della sequenza di <code>ColorPegs</code> da
	 *                  trattare
